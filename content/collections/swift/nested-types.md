...
title: 嵌套类型
date: 2026-09-08
excerpt: 在另一个类型的作用域内定义类型。
chapter: 语言指南
chapterOrder: 21
---

> 本文迁移自 SwiftGG 中文版《The Swift Programming Language 6.2.3》的[“嵌套类型”](https://doc.swiftgg.team/documentation/the-swift-programming-language/nestedtypes/)，原文由 Apple Inc.、Swift 项目作者及 SwiftGG 译者贡献，依据 Apache License 2.0（含 Runtime Library Exception）发布。本站仅做 Markdown、链接与版式适配。
...
[← 类型转换](/collections/swift/type-casting) · [扩展 →](/collections/swift/extensions)
