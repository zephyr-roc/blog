...
title: 继承
date: 2026-09-08
excerpt: 通过子类化来添加或重写功能。
chapter: 语言指南
chapterOrder: 13
---

> 本文迁移自 SwiftGG 中文版《The Swift Programming Language 6.2.3》的[“继承”](https://doc.swiftgg.team/documentation/the-swift-programming-language/inheritance/)，原文由 Apple Inc.、Swift 项目作者及 SwiftGG 译者贡献，依据 Apache License 2.0（含 Runtime Library Exception）发布。本站仅做 Markdown、链接与版式适配。
...
您可以使用属性重写的方式为继承的属性添加属性观察器。这样无论该属性最初是如何实现的，您都能够在继承属性的值发生变化时得到通知。有关属性观察器的更多信息，请参阅 [属性观察器](/collections/swift/properties#属性观察器)。
...
任何尝试在子类中重写 final 方法、属性或下标的行为都会在编译时报错。你在扩展中添加到类的方法、属性或下标也可以在扩展的定义中标记为 final。有关更多信息，请参阅 [扩展](/collections/swift/extensions)。
...
[← 下标](/collections/swift/subscripts) · [构造过程 →](/collections/swift/initialization)
