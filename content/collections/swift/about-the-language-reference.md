...
title: 关于语言参考
date: 2026-09-08
excerpt: 理解 Swift 语法描述中使用的标注。
chapter: 语言参考
chapterOrder: 30
---

> 本文迁移自 SwiftGG 中文版《The Swift Programming Language 6.2.3》的[“关于语言参考”](https://doc.swiftgg.team/documentation/the-swift-programming-language/aboutthelanguagereference/)，原文由 Apple Inc.、Swift 项目作者及 SwiftGG 译者贡献，依据 Apache License 2.0（含 Runtime Library Exception）发布。本站仅做 Markdown、链接与版式适配。
...
[← 高级运算符](/collections/swift/advanced-operators) · [词法结构 →](/collections/swift/lexical-structure)
