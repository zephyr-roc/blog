...
title: 类型转换
date: 2026-09-08
excerpt: 确定一个值的运行时类型，并为其提供更具体的类型信息。
chapter: 语言指南
chapterOrder: 20
---

> 本文迁移自 SwiftGG 中文版《The Swift Programming Language 6.2.3》的[“类型转换”](https://doc.swiftgg.team/documentation/the-swift-programming-language/typecasting/)，原文由 Apple Inc.、Swift 项目作者及 SwiftGG 译者贡献，依据 Apache License 2.0（含 Runtime Library Exception）发布。本站仅做 Markdown、链接与版式适配。
...
如 [检查是否遵循协议](/collections/swift/protocols#检查是否遵循协议) 中所述。
...
[← 宏](/collections/swift/macros) · [嵌套类型 →](/collections/swift/nested-types)
