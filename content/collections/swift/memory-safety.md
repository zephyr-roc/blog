...
title: 内存安全
date: 2026-09-08
excerpt: 通过合理地组织代码来避免内存访问冲突。
chapter: 语言指南
chapterOrder: 27
---

> 本文迁移自 SwiftGG 中文版《The Swift Programming Language 6.2.3》的[“内存安全”](https://doc.swiftgg.team/documentation/the-swift-programming-language/memorysafety/)，原文由 Apple Inc.、Swift 项目作者及 SwiftGG 译者贡献，依据 Apache License 2.0（含 Runtime Library Exception）发布。本站仅做 Markdown、链接与版式适配。
...
![](/swift-guide-assets/memory_shopping@2x.png)
...
![](/swift-guide-assets/memory_increment@2x.png)
...
![](/swift-guide-assets/memory_share_health_maria@2x.png)
...
![](/swift-guide-assets/memory_share_health_oscar@2x.png)
...
[← 自动引用计数](/collections/swift/automatic-reference-counting) · [访问控制 →](/collections/swift/access-control)
