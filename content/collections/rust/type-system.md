...
date: 2026-08-31
excerpt: Rust 类型如何描述数据、所有权、借用关系、失败路径与状态转换，以及这些机制之间的约束关系。
chapter: 类型系统
chapterOrder: 1
---
...
[`Clone`](https://doc.rust-lang.org/std/clone/trait.Clone.html) 描述显式复制能力；[`Copy`](https://doc.rust-lang.org/std/marker/trait.Copy.html) 是表示值可以在赋值和传参时隐式复制的标记 trait。
